  ...
  const stats = [
    {
      ...
      value: Number(totalResult[0].count),
      icon: Bell,
      color: 'text-blue-400',
      bg: 'bg-blue-500/10',
    ...
    {
      label: 'Pendentes',
      value: Number(pendingResult[0].count),
      icon: Clock,
    ...
    {
      label: 'Respondidas por Você',
      value: Number(respondedResult[0].count),
      icon: CheckCircle2,
      color: 'text-edp-green',
      bg: 'bg-edp-green/10',
      border: 'border-edp-green/20',
      glow: 'stat-glow-green',
    },
    {
      label: 'Urgentes',
      value: Number(urgentResult[0].count),
      icon: AlertTriangle,
      color: 'text-red-400',
      bg: 'bg-red-500/10',
    ...
    <div className="p-4 lg:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 stagger">
        {stats.map(card => (
          <div
            key={card.label}
            className={`card-hover ${card.glow} bg-edp-card rounded-xl p-4 border ${card.border} animate-slide-up`}
          >
